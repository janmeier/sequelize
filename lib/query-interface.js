...
module.exports = (function() {
  ...
  QueryInterface.prototype.select = function(factory, tableName, options, queryOptions) {
	...
	if(options && !Utils.isEmptyObject(options) && !options.hasOwnProperty('order') && !options.hasOwnProperty('group') && !options.hasOwnProperty('limit')) {
		if (!options.hasOwnProperty('where')) {
			options = { where: options }; 
		} else {
			if (Utils.isEmptyObject(options.where)) options = {};
		}
	}
