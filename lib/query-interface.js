...
module.exports = (function() {
  ...
  QueryInterface.prototype.select = function(factory, tableName, options, queryOptions) {
	if(options && !Utils.isEmptyObject(options) && !options.hasOwnProperty('where') && !options.hasOwnProperty('order') && !options.hasOwnProperty('group')	&& !options.hasOwnProperty('limit')) options.where = options; 
