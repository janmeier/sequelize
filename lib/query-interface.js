...
module.exports = (function() {
  ...
  QueryInterface.prototype.select = function(factory, tableName, options, queryOptions) {
    ...
    if(options && !Utils._.isEmpty(options) && !options.hasOwnProperty('order') && !options.hasOwnProperty('group') && !options.hasOwnProperty('limit') && !options.hasOwnProperty('attributes')) {
  ...
  var queryAndEmit = function(sqlOrQueryParams, methodName, options, emitter) {
    ...
    var execQuery = function(emitter) {
      ...
      query.on('sql', function(sql, duration) {
        emitter.emit('sql', sql, duration)
      })
    }.bind(this)
