...
module.exports = (function() {
  ...
  var getDatabaseMethod = function() {
    if (this.isInsertQuery() || this.isBulkUpdateQuery() || this.isUpdateQuery() || (this.sql.toLowerCase().indexOf('CREATE TEMPORARY TABLE'.toLowerCase()) !== -1) || this.options.type === QueryTypes.BULKDELETE) {
      return 'run';
    } else {
      return 'all';
    }
