...
module.exports = (function() {
  ...
  HasManyDoubleLinked.prototype.injectAdder = function(emitterProxy, newAssociation) {
    ...
    attributes = Utils.setAttributes(attributes, this.__factory.identifier, this.instance)
    attributes = Utils.setAttributes(attributes, foreignIdentifier, newAssociation)
