...
module.exports = (function() {
  ...
  */
  ...
  /**
   * A list of possible query types. This is mostly used internally, but is also useful in conjunction with `sequelize.query` if you expect your
   * results to be formatted in a special way.
   *
   * @property QueryTypes
   * @see {Sequelize#query}
   */
